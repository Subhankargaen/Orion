...
-It is used to create a number of defination text &their description & meaning. -<dl>tag is used to create defination list. -<dd>...</dd> & <dt>...</dt> tags are used to create defination description and defination text respectively.
e.g-

## Table :-

- We can create a structure of a table display the components in the form of cells.

## Tags Used to create the table :-

1.  <table>.....</table> :-It is used the structure of table .
2.  <tr>...</tr> :- It is used to create , display multiple cells in one row .
3.  <th>....</th> :- It is used to create a heading of the table .
4.  <td>...</td> :- It is used to create a cell in a table .
...
4. align :- it is used to align the table/content.(left,right,center)
...
- <select>....</select> :- It is a warpper element for multiple options , but it can select only one option .
